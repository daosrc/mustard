...
const zh: Content = {
  ...
  features: [
    ...
    { title: '模型提供商', desc: '默认 OpenRouter（含免费模型），支持自定义 OpenAI 兼容提供商，模型逐条配置能力。', visual: 'providers' },
  ],
  stepsTitle: '三步上手',
  steps: [
...
const en: Content = {
  ...
  features: [
    ...
    { title: 'Model providers', desc: 'OpenRouter by default (free models included), plus custom OpenAI-compatible providers with per-model capabilities.', visual: 'providers' },
  ],
