...
const zh: Content = {
  ...
  features: [
    ...
    { title: '离线词典', desc: '本地词典 → 在线词典 → AI 分级查询；词典首次使用时按需下载，下载后离线可查。', visual: 'dict' },
...
const en: Content = {
  ...
  features: [
    ...
    { title: 'Offline dictionaries', desc: 'Local → online → AI fallback; dictionaries download on first use, then work offline.', visual: 'dict' },
