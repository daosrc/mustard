...
const zh: Content = {
  ...
  features: [
    ...
    { title: '侧边栏 AI 对话', desc: '按提供商选择模型，流式输出；支持粘贴截图，并可上传文本 / PDF / DOCX 附件（本地解析，模型支持文件时直传原文件）。', visual: 'chat' },
  ...
  more: [
    ...
    { title: '网页总结', desc: '一键把网页正文交给 AI 总结，在侧边栏输出要点，忽略导航与标题。' },
    { title: '悬浮球工具', desc: '悬浮球可拖拽定位（上下随意、左右贴边），工具可排序、显隐，径向或纵向展开。' },
...
const en: Content = {
  ...
  features: [
    ...
    { title: 'Side-panel AI chat', desc: 'Pick a model per provider with streaming output; paste screenshots or upload text / PDF / DOCX attachments (parsed locally, or sent as-is when the model supports files).', visual: 'chat' },
  ...
  more: [
    ...
    { title: 'Page summary', desc: 'Send the article body to AI and get key points in the side panel, with nav and headings skipped.' },
    { title: 'Floating ball tools', desc: 'Drag the ball anywhere (vertical free, horizontal snaps to an edge); reorder and show/hide tools, radial or stacked.' },
