...
const zh: Content = {
  ...
  features: [
    ...
    { title: '生词本与记词', desc: '翻译单词自动收录、可搜索筛选与导入导出；听音默写，连续答对 3 次判定掌握。', visual: 'vocab' },
    { title: '离线词典', desc: '本地词典 → 在线词典 → AI 分级查询；内置英文常用词，无 API Key 也能查词。', visual: 'dict' },
    { title: '模型提供商', desc: '默认 OpenCode Zen，支持自定义 OpenAI 兼容提供商，模型逐条配置能力。', visual: 'providers' },
  ],
  stepsTitle: '三步上手',
  steps: [
    { n: '01', title: '安装扩展', desc: '从 GitHub Releases 下载 zip 解压，或在开发者模式加载已解压的扩展程序。' },
    { n: '02', title: '配置模型', desc: '在设置页填入 OpenCode Zen 或自定义提供商的 API Key（可选，不填也能用词典翻译）。' },
...
const en: Content = {
  ...
  features: [
    ...
    { title: 'Vocabulary & dictation', desc: 'Words are saved automatically, searchable, importable/exportable; listen-and-spell with mastery after 3 correct answers.', visual: 'vocab' },
    { title: 'Offline dictionaries', desc: 'Local dictionary → online dictionary → AI fallback; common English words are built in, so lookups work without an API key.', visual: 'dict' },
    { title: 'Model providers', desc: 'OpenCode Zen by default, plus custom OpenAI-compatible providers with per-model capabilities.', visual: 'providers' },
  ],
  ...
  steps: [
    ...
    { n: '02', title: 'Configure a model', desc: 'Add an API key for OpenCode Zen or a custom provider in settings (optional — dictionary translation works without it).' },
