...
const zh: Content = {
  ...
  features: [
    ...
    { title: '离线词典', desc: '本地词典 → 在线词典 → AI 分级查询；无 API Key 时单词查询依然可用。', visual: 'dict' },
...
const en: Content = {
  ...
  features: [
    ...
    { title: 'Offline dictionaries', desc: 'Local dictionary → online dictionary → AI fallback, so word lookups still work without an API key.', visual: 'dict' },
